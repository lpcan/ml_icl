"""
NNCLR model, adapted from https://keras.io/examples/vision/nnclr/ and 
Alice's code
"""
...
class NNCLR(keras.Model):
    def __init__(self, input_shape, temperature, queue_size):
        super().__init__()
        # Define metrics
        ...
        # Define augmenter
        self.contrastive_augmenter = augmenter(input_shape)

        # Define model structure
        self.encoder = encoder(input_shape)
        self.projection_head = keras.Sequential(
            [
                layers.Input(shape=(256), name="projection_input"), 
    ...
    def update_correlation_accuracy(self, features_1, features_2):
        ...
        # (most similar activations should correspond to same feature)
        # (I think)
